...
########## COMPONENTS TARGET PROPERTIES Debug ########################################
    ...
    ########## COMPONENT Boost::cobalt #############
        ...
        set(boost_Boost_cobalt_FRAMEWORKS_FOUND_DEBUG "")
        conan_find_apple_frameworks(boost_Boost_cobalt_FRAMEWORKS_FOUND_DEBUG "${boost_Boost_cobalt_FRAMEWORKS_DEBUG}" "${boost_Boost_cobalt_FRAMEWORK_DIRS_DEBUG}")
        ...
        set_property(TARGET boost_Boost_cobalt_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${boost_Boost_cobalt_FRAMEWORKS_FOUND_DEBUG}>
                     $<$<CONFIG:Debug>:${boost_Boost_cobalt_SYSTEM_LIBS_DEBUG}>
                     $<$<CONFIG:Debug>:${boost_Boost_cobalt_DEPENDENCIES_DEBUG}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'boost_Boost_cobalt_DEPS_TARGET' to all of them
        conan_package_library_targets("${boost_Boost_cobalt_LIBS_DEBUG}"
                              "${boost_Boost_cobalt_LIB_DIRS_DEBUG}"
                              "${boost_Boost_cobalt_BIN_DIRS_DEBUG}" # package_bindir
                              "${boost_Boost_cobalt_LIBRARY_TYPE_DEBUG}"
                              "${boost_Boost_cobalt_IS_HOST_WINDOWS_DEBUG}"
                              boost_Boost_cobalt_DEPS_TARGET
                              boost_Boost_cobalt_LIBRARIES_TARGETS
                              "_DEBUG"
                              "boost_Boost_cobalt"
                              "${boost_Boost_cobalt_NO_SONAME_MODE_DEBUG}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Boost::cobalt
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${boost_Boost_cobalt_OBJECTS_DEBUG}>
                     $<$<CONFIG:Debug>:${boost_Boost_cobalt_LIBRARIES_TARGETS}>
                     )

        if("${boost_Boost_cobalt_LIBS_DEBUG}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Boost::cobalt
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
