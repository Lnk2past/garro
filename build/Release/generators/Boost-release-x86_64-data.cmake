...
list(APPEND boost_COMPONENT_NAMES Boost::diagnostic_definitions Boost::disable_autolinking Boost::dynamic_linking Boost::headers Boost::boost boost::_libboost Boost::atomic Boost::charconv Boost::container Boost::context Boost::date_time Boost::exception Boost::math Boost::program_options Boost::regex Boost::serialization Boost::stacktrace Boost::system Boost::timer Boost::chrono Boost::cobalt Boost::coroutine Boost::filesystem Boost::json Boost::math_c99 Boost::math_c99f Boost::math_c99l Boost::math_tr1 Boost::math_tr1f Boost::math_tr1l Boost::random Boost::stacktrace_addr2line Boost::stacktrace_backtrace Boost::stacktrace_basic Boost::stacktrace_from_exception Boost::stacktrace_noop Boost::test Boost::url Boost::wserialization Boost::fiber Boost::graph Boost::iostreams Boost::nowide Boost::prg_exec_monitor Boost::test_exec_monitor Boost::thread Boost::wave Boost::contract Boost::fiber_numa Boost::locale Boost::log Boost::type_erasure Boost::unit_test_framework Boost::log_setup)
...
########### VARIABLES #######################################################################
#############################################################################################
set(boost_PACKAGE_FOLDER_RELEASE "/root/.conan2/p/b/booste02efd78f0ac9/p")
...
set(boost_LIBS_RELEASE boost_log_setup boost_unit_test_framework boost_type_erasure boost_log boost_locale boost_fiber_numa boost_contract boost_wave boost_thread boost_test_exec_monitor boost_prg_exec_monitor boost_nowide boost_iostreams boost_graph boost_fiber boost_wserialization boost_url boost_stacktrace_noop boost_stacktrace_from_exception boost_stacktrace_basic boost_stacktrace_backtrace boost_stacktrace_addr2line boost_random boost_math_tr1l boost_math_tr1f boost_math_tr1 boost_math_c99l boost_math_c99f boost_math_c99 boost_json boost_filesystem boost_coroutine boost_cobalt boost_chrono boost_timer boost_serialization boost_regex boost_program_options boost_exception boost_date_time boost_context boost_container boost_charconv boost_atomic)
...
set(boost_Boost_stacktrace_from_exception_INCLUDE_DIRS_RELEASE )
set(boost_Boost_stacktrace_from_exception_LIB_DIRS_RELEASE "${boost_PACKAGE_FOLDER_RELEASE}/lib")
set(boost_Boost_stacktrace_from_exception_BIN_DIRS_RELEASE )
set(boost_Boost_stacktrace_from_exception_LIBRARY_TYPE_RELEASE STATIC)
set(boost_Boost_stacktrace_from_exception_IS_HOST_WINDOWS_RELEASE 0)
set(boost_Boost_stacktrace_from_exception_RES_DIRS_RELEASE )
set(boost_Boost_stacktrace_from_exception_DEFINITIONS_RELEASE )
set(boost_Boost_stacktrace_from_exception_OBJECTS_RELEASE )
set(boost_Boost_stacktrace_from_exception_COMPILE_DEFINITIONS_RELEASE )
set(boost_Boost_stacktrace_from_exception_COMPILE_OPTIONS_C_RELEASE "")
set(boost_Boost_stacktrace_from_exception_COMPILE_OPTIONS_CXX_RELEASE "")
set(boost_Boost_stacktrace_from_exception_LIBS_RELEASE boost_stacktrace_from_exception)
set(boost_Boost_stacktrace_from_exception_SYSTEM_LIBS_RELEASE dl)
set(boost_Boost_stacktrace_from_exception_FRAMEWORK_DIRS_RELEASE )
set(boost_Boost_stacktrace_from_exception_FRAMEWORKS_RELEASE )
set(boost_Boost_stacktrace_from_exception_DEPENDENCIES_RELEASE Boost::stacktrace boost::_libboost)
set(boost_Boost_stacktrace_from_exception_SHARED_LINK_FLAGS_RELEASE )
set(boost_Boost_stacktrace_from_exception_EXE_LINK_FLAGS_RELEASE )
set(boost_Boost_stacktrace_from_exception_NO_SONAME_MODE_RELEASE FALSE)

# COMPOUND VARIABLES
set(boost_Boost_stacktrace_from_exception_LINKER_FLAGS_RELEASE
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${boost_Boost_stacktrace_from_exception_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${boost_Boost_stacktrace_from_exception_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${boost_Boost_stacktrace_from_exception_EXE_LINK_FLAGS_RELEASE}>
)
set(boost_Boost_stacktrace_from_exception_COMPILE_OPTIONS_RELEASE
    "$<$<COMPILE_LANGUAGE:CXX>:${boost_Boost_stacktrace_from_exception_COMPILE_OPTIONS_CXX_RELEASE}>"
    "$<$<COMPILE_LANGUAGE:C>:${boost_Boost_stacktrace_from_exception_COMPILE_OPTIONS_C_RELEASE}>")
...
set(boost_Boost_cobalt_INCLUDE_DIRS_RELEASE )
set(boost_Boost_cobalt_LIB_DIRS_RELEASE "${boost_PACKAGE_FOLDER_RELEASE}/lib")
set(boost_Boost_cobalt_BIN_DIRS_RELEASE )
set(boost_Boost_cobalt_LIBRARY_TYPE_RELEASE STATIC)
set(boost_Boost_cobalt_IS_HOST_WINDOWS_RELEASE 0)
set(boost_Boost_cobalt_RES_DIRS_RELEASE )
set(boost_Boost_cobalt_DEFINITIONS_RELEASE )
set(boost_Boost_cobalt_OBJECTS_RELEASE )
set(boost_Boost_cobalt_COMPILE_DEFINITIONS_RELEASE )
set(boost_Boost_cobalt_COMPILE_OPTIONS_C_RELEASE "")
set(boost_Boost_cobalt_COMPILE_OPTIONS_CXX_RELEASE "")
set(boost_Boost_cobalt_LIBS_RELEASE boost_cobalt)
set(boost_Boost_cobalt_SYSTEM_LIBS_RELEASE )
set(boost_Boost_cobalt_FRAMEWORK_DIRS_RELEASE )
set(boost_Boost_cobalt_FRAMEWORKS_RELEASE )
set(boost_Boost_cobalt_DEPENDENCIES_RELEASE Boost::container Boost::system boost::_libboost)
set(boost_Boost_cobalt_SHARED_LINK_FLAGS_RELEASE )
set(boost_Boost_cobalt_EXE_LINK_FLAGS_RELEASE )
set(boost_Boost_cobalt_NO_SONAME_MODE_RELEASE FALSE)

# COMPOUND VARIABLES
set(boost_Boost_cobalt_LINKER_FLAGS_RELEASE
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${boost_Boost_cobalt_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${boost_Boost_cobalt_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${boost_Boost_cobalt_EXE_LINK_FLAGS_RELEASE}>
)
set(boost_Boost_cobalt_COMPILE_OPTIONS_RELEASE
    "$<$<COMPILE_LANGUAGE:CXX>:${boost_Boost_cobalt_COMPILE_OPTIONS_CXX_RELEASE}>"
    "$<$<COMPILE_LANGUAGE:C>:${boost_Boost_cobalt_COMPILE_OPTIONS_C_RELEASE}>")
...
set(boost_Boost_charconv_INCLUDE_DIRS_RELEASE )
