...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT Boost::stacktrace_from_exception #############
        ...
        set(boost_Boost_stacktrace_from_exception_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(boost_Boost_stacktrace_from_exception_FRAMEWORKS_FOUND_RELEASE "${boost_Boost_stacktrace_from_exception_FRAMEWORKS_RELEASE}" "${boost_Boost_stacktrace_from_exception_FRAMEWORK_DIRS_RELEASE}")
        ...
        set_property(TARGET boost_Boost_stacktrace_from_exception_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${boost_Boost_stacktrace_from_exception_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${boost_Boost_stacktrace_from_exception_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${boost_Boost_stacktrace_from_exception_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'boost_Boost_stacktrace_from_exception_DEPS_TARGET' to all of them
        conan_package_library_targets("${boost_Boost_stacktrace_from_exception_LIBS_RELEASE}"
                              "${boost_Boost_stacktrace_from_exception_LIB_DIRS_RELEASE}"
                              "${boost_Boost_stacktrace_from_exception_BIN_DIRS_RELEASE}" # package_bindir
                              "${boost_Boost_stacktrace_from_exception_LIBRARY_TYPE_RELEASE}"
                              "${boost_Boost_stacktrace_from_exception_IS_HOST_WINDOWS_RELEASE}"
                              ...
                              "${boost_Boost_stacktrace_from_exception_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Boost::stacktrace_from_exception
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${boost_Boost_stacktrace_from_exception_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${boost_Boost_stacktrace_from_exception_LIBRARIES_TARGETS}>
                     )

        if("${boost_Boost_stacktrace_from_exception_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Boost::stacktrace_from_exception
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    ...
    ########## COMPONENT Boost::cobalt #############

        set(boost_Boost_cobalt_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(boost_Boost_cobalt_FRAMEWORKS_FOUND_RELEASE "${boost_Boost_cobalt_FRAMEWORKS_RELEASE}" "${boost_Boost_cobalt_FRAMEWORK_DIRS_RELEASE}")

        set(boost_Boost_cobalt_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET boost_Boost_cobalt_DEPS_TARGET)
            add_library(boost_Boost_cobalt_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET boost_Boost_cobalt_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'boost_Boost_cobalt_DEPS_TARGET' to all of them
        conan_package_library_targets("${boost_Boost_cobalt_LIBS_RELEASE}"
                              "${boost_Boost_cobalt_LIB_DIRS_RELEASE}"
                              "${boost_Boost_cobalt_BIN_DIRS_RELEASE}" # package_bindir
                              "${boost_Boost_cobalt_LIBRARY_TYPE_RELEASE}"
                              "${boost_Boost_cobalt_IS_HOST_WINDOWS_RELEASE}"
                              boost_Boost_cobalt_DEPS_TARGET
                              boost_Boost_cobalt_LIBRARIES_TARGETS
                              "_RELEASE"
                              "boost_Boost_cobalt"
                              "${boost_Boost_cobalt_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Boost::cobalt
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_LIBRARIES_TARGETS}>
                     )

        if("${boost_Boost_cobalt_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Boost::cobalt
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Boost::cobalt APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET Boost::cobalt APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET Boost::cobalt APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_LIB_DIRS_RELEASE}>)
        set_property(TARGET Boost::cobalt APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET Boost::cobalt APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${boost_Boost_cobalt_COMPILE_OPTIONS_RELEASE}>)
    ...
    set_property(TARGET boost::boost APPEND PROPERTY INTERFACE_LINK_LIBRARIES Boost::cobalt)
